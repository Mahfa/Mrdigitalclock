...
public class Roozh {
	...
	public String todayShamsi() {
		...
		int Y = Integer.parseInt(curentDateandTime.substring(0, 4));
		int M = Integer.parseInt(curentDateandTime.substring(4, 6));
		int D = Integer.parseInt(curentDateandTime.substring(6, 8));
		GregorianToPersian(Y, M, D);
